...
class Bird:
    ...
    def __init__(self, num: int, xy: tuple[int, int]):
        ...
        kk_img0 = pg.transform.rotozoom(pg.image.load(f"ex03/fig/{num}.png"), 0, 2.0)
        kk_img1 = pg.transform.flip(kk_img0, True, False)  # 右向き, ２倍
        self._imgs = {
            (1, 0): kk_img1,   # 右
            (1, -1): pg.transform.rotozoom(kk_img1, 45, 1.0),   # 右上
            (0, -1): pg.transform.rotozoom(kk_img1, 90, 1.0),  # 上
            (-1, -1): pg.transform.rotozoom(kk_img0, -45, 1.0),  # 左上
            (-1, 0): kk_img0,  # 左
            (-1, 1): pg.transform.rotozoom(kk_img0, 45, 1.0),  # 左下
            (0, 1): pg.transform.rotozoom(kk_img1, -90, 1.0),  # 下
            (1, 1): pg.transform.rotozoom(kk_img1, -45, 1.0)  # 右下
        }
...
class Bomb:
    ...
    def __init__(self):
        ...
        self._vx, self._vy = random.choice(self._dires), random.choice(self._dires)
